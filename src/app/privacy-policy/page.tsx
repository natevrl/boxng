...
function page() {
  return (
    <main className="min-h-screen-nav container flex flex-col gap-4 px-5 py-8 sm:px-8 md:gap-6 lg:py-16 xl:gap-8">
    <section className='flex grow flex-col'>
      <h1 className='scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl'>
        Privacy Policy
      </h1>
      <p className='leading-7 [&:not(:first-child)]:mt-6'>Last updated: February 03, 2024</p>
      ...
      <h3 className='mt-8 scroll-m-20 text-2xl font-semibold tracking-tight'>Interpretation</h3>
      <p className='leading-7 [&:not(:first-child)]:mt-6'>
        The words of which the initial letter is capitalized have meanings defined under the
        following conditions. The following definitions shall have the same meaning regardless of
        whether they appear in singular or in plural.
      </p>
      <h3 className='mt-8 scroll-m-20 text-2xl font-semibold tracking-tight'>Definitions</h3>
      <p className='leading-7 [&:not(:first-child)]:mt-6'>
      ...
      <ul className='my-6 ml-6 list-disc [&>li]:mt-2'>
        ...
        <li>
          ...
          Agreement) refers to Axial inc. 59 Drip Rd, Stirling FK8 1RN, UK.
        </li>
        <li>
      ...
      <h4 className='mt-6 scroll-m-20 text-xl font-semibold tracking-tight'>Personal Data</h4>
      <p className='leading-7 [&:not(:first-child)]:mt-6'>
      ...
      <h4 className='mt-6 scroll-m-20 text-xl font-semibold tracking-tight'>Usage Data</h4>
      <p className='leading-7 [&:not(:first-child)]:mt-6'>
      ...
      <h4 className='mt-6 scroll-m-20 text-xl font-semibold tracking-tight'>Law enforcement</h4>
      <p className='leading-7 [&:not(:first-child)]:mt-6'>
      ...
      <p className='leading-7 [&:not(:first-child)]:mt-6'>
        ...
        <span className='underline underline-offset-4'>website.born2ring@gmail.com</span>
      </p>
    </section>
    </main>
  );
